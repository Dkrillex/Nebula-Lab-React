    ...
    <div className="container mx-auto px-4 py-8 md:py-12 min-h-[80vh]">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-muted">共 {pagination.total} 个令牌</span>
        </div>
        <div className="flex items-center gap-2">
          <button 
            onClick={fetchTokens}
            disabled={loading}
            className="flex items-center gap-2 px-4 py-2 rounded-lg border border-border hover:bg-surface transition-colors disabled:opacity-50"
          >
